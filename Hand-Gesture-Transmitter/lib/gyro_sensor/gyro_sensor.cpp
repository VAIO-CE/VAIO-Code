...
uint8_t GyroSensor::devStatus;      // return status after each device operation (0 = success, !0 = error)
uint16_t GyroSensor::packetSize;    // expected DMP packet size (default is 42 bytes)
